		...
		var toolbarEnv = function() {
			return {
				...
				findPanel: function(s) {
					...
					var apid = mm[1];
					var ad = null;
					if (userAdapterById[apid] !== void 0) ad = userAdapterById[apid];
					else ad = builtinAdapter(apid);
					if (ad === null) return null;
					var act = ad.act;
					if (act === void 0 || act.kind !== "toggle-panel" || !act.close) return null;
					var closeSel = act.close;
					var btnSel = ad.button;
					return {
						isOpen: function() {
							var c = document.querySelector(closeSel);
